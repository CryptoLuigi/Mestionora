...
class TagModal(Modal):
    def __init__(self, usemode, msg, tagn):
        ...
        self.tagname = TextInput(label="Name of the Tag:", min_length=1, max_length=50, required=True, default_value=f"{tagn}", placeholder="Tag Name", style=nextcord.TextInputStyle.short,)
        self.add_item(self.tagname)
        self.tagcontent = TextInput(label="Tag Content:", min_length=1, max_length=4000, required=True, default_value=f"{msg}", placeholder="Enter wisdom here", style=nextcord.TextInputStyle.paragraph,)
...
class SetPage(Modal):
    def __init__(self):
        ...
        self.setpagenb = TextInput(label="Page number:", min_length=1, max_length=50, required=True, style=TextInputStyle.short)
